...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] md:w-full max-w-[885px] z-50">
      {/* Pill-shaped navigation bar */}
      <nav className="relative rounded-full bg-white px-6 py-2.5 sm:px-8 shadow-sm flex items-center justify-between">
      ...
      {/* Mobile menu dropdown — rendered outside the rounded-full nav so it isn't clipped */}
      {isOpen && (
        <div className="mt-2 bg-white border border-border rounded-2xl p-6 shadow-lg flex flex-col gap-4 md:hidden">
          <Link
            href="/pricing"
